                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-2 text-right">
                        <div class="font-size-20 text-danger font-baloo">
                            <span class="product_price">1,200,000</span>원
                        </div>
                    </div>
                </div>
                <div class="row border-top py-3 mt-3">
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        <h5 class="font-baloo font-size-20">Subtotal (2 item):&nbsp;<span class="text-danger">2,400,000<span class="text-danger" id="deal-price">원</span></span></h5>
